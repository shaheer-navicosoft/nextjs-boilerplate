...
const Usdt = () => {
  ...
  return (
    <div className="max-w-full mx-6 my-12  gap-10 bg-white py-12 rounded-2xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 p-6">
      <div className="  flex flex-col md:border-r-2   border-gray-200  lg:mr-5 ">
        ...
        <p className="text-[32px] font-[600] mt-1">
          {totalApprovedAmount} USDT
        </p>
        <p className="text-[#83BF6E] bg-[#FCFCFC] rounded-[4px] p-1 max-w-[142px]  font-medium text-[12px] flex gap-1 items-center mt-2">
          {" "}
          <span>
            <svg
              width="12"
          ...
          37.8% <span className="text-[#666E78]">from last week</span>{" "}
        </p>
      </div>
      ...
      <div className="  flex flex-col md:border-r-2 border-gray-200 lg:mr-5 lg:ml-6 ">
        ...
        <p className="text-[#FF6A55] bg-[#FCFCFC] rounded-[4px] p-1 max-w-[142px] font-medium text-[12px] flex gap-1 items-center mt-2">
          {" "}
          <span>
            <svg
              width="12"
      ...
      <div className="  flex flex-col  lg:mr-5 lg:ml-6 ">
        ...
        <p className="text-[32px] font-[600] mt-1">{users.length - 1}</p>
      </div>
    </div>
  );
};
